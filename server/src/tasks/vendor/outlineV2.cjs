// Derived from palmtom316/yibiao b079bc0d923c4a533b9c2de3a9f573f4c75d8137
// client/electron/services/outlineGenerationTaskV2.cjs (pure algorithms/prompts). AGPL-3.0-only.
// PostgreSQL orchestration and Web confirmations: ../runners/outline-v2.ts.
...
module.exports = {
  ...
  normalizeWordControlOptions,
  deriveTargetLeafCount,
  enforceMinimumLeafTarget,
  renumberOutline,
  buildFinalOutline,
  stripOutlineInternalFields,
  attachBranchIdsToRoots,
  synchronizeScoreDirectoryPlan,
  countAiLeaves,
  countLeavesByMode,
